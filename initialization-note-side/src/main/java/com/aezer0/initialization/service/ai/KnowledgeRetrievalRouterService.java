...
public class KnowledgeRetrievalRouterService {
    ...
    public RetrievalPlan plan(String query, String categoryFilter, boolean sharedKnowledgeBase) {
        ...
        boolean explicitFileIntent = containsAny(normalizedQuery, "文件", "文档", "文章", "资料", "笔记", ".pdf", ".doc", ".docx", ".md", ".txt");
        boolean summaryIntent = containsAny(normalizedQuery, "总结", "概览", "整体", "简介", "是什么", "梳理", "汇总", "有哪些");
        boolean exactIntent = containsAny(normalizedQuery, "叫", "名称", "标题", "文件名", "分类", "出处", "来源");

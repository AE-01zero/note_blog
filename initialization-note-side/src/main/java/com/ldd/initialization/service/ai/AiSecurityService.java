...
import com.ldd.initialization.service.AnalysisHistoryService;
...
public class AiSecurityService {
    ...
    /** 保存分析历史 */
    public com.ldd.initialization.domain.AnalysisHistory saveAnalysisHistory(
    ...
    /** 获取反编译记录 */
    public List<com.ldd.initialization.domain.DecompileRecord> getDecompileRecords(Long userId) {

...
import com.ldd.initialization.domain.AnalysisHistory;
import com.ldd.initialization.domain.DecompileRecord;
...
import com.ldd.initialization.service.ai.StreamingAnalysisService;
import com.ldd.initialization.service.apktool.ApkToolService;
import com.ldd.initialization.service.ai.SecurityAnalysisLlmService;
...
public class AiSecurityController {
    ...
    @Autowired
    private com.ldd.initialization.service.AnalysisHistoryService analysisHistoryService;
    ...
    public Result<Map<String, Object>> saveAnalysisHistory(@RequestBody Map<String, Object> data) {
        ...
        try {
            ...
            com.ldd.initialization.domain.AnalysisHistory history =
